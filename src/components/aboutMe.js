  ...
  return (
    <section className="text-white pt-6 pb-20" id="about">
      ...
      <p className="px-4 pb-4">
        I have master degree in Eletrotecnical and Computers Engineering and had
        my first job before finishing my studies as a Support Specialist. While
        I developed and improved many technical skills such as SQL, JavaScript
        and C# working in fast paced production environments, I've also managed
        to consolidate the ability to prioritize tasks and to work effectively
        under pressure.
      </p>
      <p className="px-4 pb-12">
        ...
        to continuous improvement and to exceed myself.
      </p>
